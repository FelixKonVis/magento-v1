<?php
class UnzerDirect_Payment_MobilepayController extends Mage_Core_Controller_Front_Action
{
    public function redirectAction(){
        ...
        if(empty($params['shipping'])){
            $error = Mage::helper('unzerdirect_payment')->__('Please specify a shipping method.');
        } else {
            $shippingData = Mage::getModel('unzerdirect_payment/carrier_shipping')->getMethodByCode($params['shipping']);
        ...
        try {
            ...
            $shippingAddress->setCollectShippingRates(true)->collectShippingRates()->setShippingMethod('unzerdirect_mobilepay_unzerdirect_mobilepay');

            // Set Sales Order Payment
            $quote->getPayment()->importData(['method' => 'unzerdirect_mobilepay']);
...
// Get array of selections
            ...
            $result = Mage::helper('unzerdirect_payment')->qpCreateMobilepayPayment($order, $shippingServiceData);
    ...
    {
        return Mage::getUrl('unzerdirect_payment/payment/success');
    }
    ...
    {
        return Mage::getUrl('unzerdirect_payment/payment/cancel');
    }
    ...
    {
        return Mage::getUrl('unzerdirect_payment/payment/callback');
    }
}