...
class UnzerDirect_Payment_Adminhtml_UnzerDirectController extends Mage_Adminhtml_Controller_Action
{
    public function massCaptureAction()
    {
        ...
        foreach ($orderIds as $orderId) {
            ...
            if (!$order->getPayment()->getMethodInstance() instanceof UnzerDirect_Payment_Model_Method_Abstract) {
                $this->_getSession()->addError($this->__('%s Order was not placed using UnzerDirect', $order->getIncrementId()));
                continue;
            }
