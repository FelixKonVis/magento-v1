<?php
class UnzerDirect_Payment_Model_Payment extends Mage_Payment_Model_Method_Abstract
{
    ...
    {
        return Mage::getSingleton('unzerdirect_payment/session');
    }
    ...
    public function canUseInternal()
    {
        ...
        if (Mage::app()->getFrontController()->getAction() instanceof Mage_Adminhtml_Sales_Order_EditController) {
            // Her kunne testes om det i forvejen er en UnzerDirect order.
    ...
    public function createFormBlock($name)
    {
        $block = $this->getLayout()
            ->createBlock('unzerdirect_payment/payment_form', $name)
            ->setMethod('unzerdirect_payment')
            ->setPayment($this->getPayment())
            ->setTemplate('unzerdirectpayment/payment/form.phtml');

        return $block;
    }

    /*validate the currency code is avaialable to use for UnzerDirect or not*/
    public function validate()
    {
        ...
        if (! Mage::app()->getFrontController()->getAction() instanceof Mage_Adminhtml_Sales_Order_EditController) {
            ...
            if (!in_array($currency_code, $this->_allowCurrencyCode)) {
                Mage::throwException(Mage::helper('unzerdirect_payment')->__('Valutakoden (%s) er ikke kompatible med UnzerDirect', $currency_code));
            }
        }
